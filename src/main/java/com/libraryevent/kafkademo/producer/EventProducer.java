...
public class EventProducer {
	...
	public void sendLibraryEvent_Appraoch(Record custRecord,Customer cust) throws JsonProcessingException {

		logger.info("inside the event of producer");

		Integer key= (Integer)cust.getCustId();
		String value=objMapper.writeValueAsString(custRecord);
